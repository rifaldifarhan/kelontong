    ...
    <div class="col-lg-7">
        <div class="p-5">
            ...
            <?php foreach ($user as $baris) { ?>
                <form class="user" action="<?php echo base_url('index.php/mahasiswa/update'); ?>" method="post">
                    ...
                    <div class="form-Group">
                        <select class="form-control" id="grup" require>
                            <?php foreach ($grups as $grup) : { ?>
                                    <option value="<?php echo $grup->id_grup; ?>"><?php echo $grup->grup; ?></option>
                            <?php }
                            endforeach; ?>
                        </select>
                    </div>
