...
<head>
    ...
    <!-- Custom bootstrapt tables for this template-->
    <link rel="stylesheet" href="<?= base_url('asset/datatables-bs4/css/dataTables.bootstrap4.min.css'); ?>">
    <link rel="stylesheet" href="<?= base_url('asset/datatables-responsive/css/responsive.bootstrap4.min.css'); ?>">
